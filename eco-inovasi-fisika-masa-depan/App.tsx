    ...
    <div className="min-h-screen text-slate-900 bg-[#fdfdfd] overflow-x-hidden selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'bg-white/90 backdrop-blur-xl shadow-lg py-3' : 'bg-transparent py-8'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          {/* Button Hubungi Kami Dihilangkan di sini sesuai instruksi */}
          ...
          <div className="relative bg-gradient-to-br from-slate-900 to-slate-800 rounded-[4rem] p-12 md:p-24 text-center overflow-hidden shadow-3xl">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <a 
                  href="https://www.canva.com/design/DAG-ORvd36M/MU1TKFPncU6SCcN2Cs-Aug/edit?utm_content=DAG-ORvd36M&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-4 bg-white/10 backdrop-blur-md p-10 rounded-[3rem] border border-white/10 hover:bg-white/20 transition-all group hover:scale-105 active:scale-95"
                >
                ...
                <a 
                  href="https://github.com/QizzyCO/library/raw/refs/heads/main/Presentation%20tugas.pptx"
                  download="Presentasi_Fisika_Eco_Inovasi.pptx"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-4 bg-white/10 backdrop-blur-md p-10 rounded-[3rem] border border-white/10 hover:bg-white/20 transition-all group hover:scale-105 active:scale-95"
                >
                ...
                <a 
                  href="https://github.com/QizzyCO/library/raw/refs/heads/main/makalah.docx"
                  download="Laporan_Fisika_Eco_Inovasi.docx"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-4 bg-white/10 backdrop-blur-md p-10 rounded-[3rem] border border-white/10 hover:bg-white/20 transition-all group hover:scale-105 active:scale-95 text-center"
                >
